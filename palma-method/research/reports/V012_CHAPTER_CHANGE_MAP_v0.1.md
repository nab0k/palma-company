...
change_scope: chapters_1_15
---

# v0.12 chapter change map

This is the working ledger for the full manuscript pass. `pending` means the
chapter has not yet received the second, founder-directed audit; it does not mean
that v0.11 contained no edit.

| Chapter | Function to preserve | Main founder-directed repair | Status |
|---|---|---|---|
| 1 — Vipassana | Lived opening; feeling, continuation, infrastructure | Reduce synthetic oppositions; keep Pagis memorable; make the manifesto frame audible without a defensive appendix tone | first_pass_complete; detailed_TCF_scene_clearance_pending |
...
- Every chapter begins with a question, scene, or problem the author can honestly
  own.
- No substantial scholar appears before the reader knows why the work is needed.
- One abstract paragraph is followed by a concrete referent.
- The speaker of every generalization is visible: author, interview participant,
  dataset, source, or explicitly proposed test.
- Each international case performs its approved mechanism and no removed case
  returns by analogy.
