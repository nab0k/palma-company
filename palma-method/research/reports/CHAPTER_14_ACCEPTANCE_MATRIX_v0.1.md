# Chapter 14 Acceptance Matrix v0.1

## How to read this file

`BEFORE` quotes the exact wording that triggered the comment, primarily from
`PALMA_METHOD_MANUSCRIPT_v0.10.md`. `AFTER` quotes the separate acceptance
candidate and gives its line anchor. No AFTER text has been inserted into the
manuscript. `WHY` records the editorial decision rather than merely saying that
the prose became clearer.

## A. Current whole-book comments as applied to Chapter 14

### G14-01 — Protect the name TAK.Shtab

- **BEFORE:** Chapter 14 v0.10 and v0.11 contain no reference to the
  organization; the translation risk arises elsewhere from alternating
  `TAK.Shtab` and the generic `Штаб`.
- **AFTER:** Candidate lines 1–5 explicitly remain outside the manuscript; the
  self-check fixes the future English form as `TAK.Shtab (Ukrainian: “Так. Це
  штаб”)`, then `TAK.Shtab`, never `HQ`.
- **WHY:** There is nothing to rename inside this chapter. Inventing a mention
  merely to demonstrate compliance would create a new problem. The package
  records the rule and tests the complete candidate for accidental occurrence.

### G14-02 — Remove manufactured “not X, but Y”
...
### G14-03 — Break up abstract passages that lose the reader
...
### G14-04 — Replace the omniscient launch-expert tone
...
### G14-05 — Chapter 14 failed as a whole

- **BEFORE:** The chapter opened with an unsupported generalization, travelled
  to a seven-person murder through an HBR anecdote, then introduced four
  unrelated research blocks and several examples.
- **AFTER:** The candidate follows the v0.11 decision chain: limited probe
  (Cynefin), observed behavior (Signals), evidence and comparison, spread
  (Rogers), interpretation (Weiss), group-level meaning (Sampson et al.),
  decision, handoff. The late position of Sampson is explicitly left for founder
  judgment in the unresolved list.
- **WHY:** The repair is architectural. Local polishing could not give the old
  sequence a reason for each scholar to appear.

### G14-06 — Make the manifesto position audible
...
- **WHY:** Kahneman and Tversky already have a bounded role in Chapter 12.
  Repeating their names here would turn a useful method into a label and add a
  fifth scholar block to an already dense chapter.
...
### G14-09 — Repair fog and broken narrative logic

- **BEFORE:** Sampson, Raudenbush, and Earls appeared after Weiss and the null
  result, although their distinction between atmosphere and expected action is
...
### G14-10 — Do not ignore previous comments

- **BEFORE:** v0.10 retained the murder story, unexplained Cynefin vocabulary,
  fifth-edition trivia, generic “руководитель,” and “команда принимает,” despite
  direct comments on each.
- **AFTER:** Sections B and C below give each relevant discussion its own exact
  disposition and candidate anchor.
- **WHY:** Acceptance must be auditable comment by comment, rather than inferred
  from the existence of a new manuscript version.

### G14-11 — Connect classics to current research

- **BEFORE:** Chapter 14 uses works from 1962, 1997, and 2007 without a recent
  empirical continuation.
- **AFTER:** The candidate does not add an unapproved modern study. The open
  question list asks whether the 2024 or 2026 network-intervention research
  should replace part of the existing measurement section.
- **WHY:** A recent date is useful only if it changes the inference. Adding a
  fifth research block before the founder accepts the chapter would repeat the
  literature-inventory problem.

### G14-12 — Stop global editing until the pilot is accepted

- **BEFORE:** v0.11 had already been created as a full-manuscript version and
  placed in PR #31.
- **AFTER:** Candidate lines 3–5 state that the text is a pilot and cannot be
  moved into the manuscript. TASK_CODEX_0040 forbids edits to v0.11 and PR #31.
- **WHY:** The founder needs one contained object to approve before the same
  editorial logic is used elsewhere.

## B. Notion comments attached directly to Chapter 14
...
### N10-079 — The murder and deputy-police-chief example has no earned role
...
### N10-080 — The Cynefin retelling lacks value for this book
...
### N10-081 — The five-domain explanation is foggy
...
### N10-082 — The equipment-assembly example is unclear
...
### N10-083 — Explain why Palma Method is mentioned in a pre-Method story
...
### N10-084 — Rogers enters without a bridge

- **BEFORE:** “Эверетт Роджерс пришёл к теории распространения инноваций не
...
### N10-086 — Fifth-edition trivia is unnecessary
...
### N10-087 — Clarify that stages are not automatic

- **BEFORE:** “Эти стадии помогают задавать вопросы, но не превращают живого
...
### N10-088 — Generic “руководитель” narrows the audience

- **BEFORE:** “Эти свойства дают руководителю более полезный вопрос...”
  (v0.10.)
...
### N10-089 — “The famous curve” is unexplained
...
### N10-090 — Weiss enters without presentation

- **BEFORE:** “Кэрол Вайс настаивала, что оценка социальных программ происходит
...
### N10-091 — The abstract-versus-body sample discrepancy is a detour
...
### N10-092 — Undefined “we often measure” claims authority
...
### N10-093 — Explain why participant-side safety belongs here
...
### N10-094 — “The team decides” pretends this is established practice
...
### N10-056 — Stop repeating that a story does not prove the Method
...
### N10-075 — Consolidate research disclaimers
...
### N10-096 — Remove decorative “uncomfortable” language
...
### N10-098 — Prefer the author's explanatory cadence to compressed AI cadence
...
### N10-099 — Use cognitive-bias names only where they clarify a mechanism

- **BEFORE:** “В одном случае тот просто сообщал собственное предпочтение... В
  другом случае содержание было почти тем же, но форма менялась...” (v0.10,
  Chapter 15; the founder suggested connecting this to framing.)
...
### N10-100 — Remove decorative evaluations of an argument
...
### N10-102 — Carry the founder's preferred reasoning rhythm into the close

- **BEFORE:** “Поэтому завершение цикла — не отчёт о выполненных активностях.
  Это разговор о том, что теперь способны делать другие...” (v0.10, Chapter
...
### N10-101 — Remove model-like consultant language

- **BEFORE:** The chapter alternated between `организатор`, `руководитель`,
  `команда`, and an unnamed evaluating “we.”
- **AFTER:** The candidate uses `я предлагаю` for the Method, names the actor in
  examples, and uses `участник` or `организация` for observable roles.
- **WHY:** Pronouns and roles now disclose who is entitled to each claim.

### N10-103 — Remove the prepared “my main proposition is simple” ending

- **BEFORE:** The wider v0.10 conclusion used “Моё главное предположение
...
This matrix covers the twelve current founder comments, all seventeen Notion
comments directly attached to Chapter 14 (`N10-001`, `N10-079`–`N10-094`), and
ten earlier whole-book voice comments with direct consequences for the pilot.
Comments about the content of other chapters are intentionally excluded because
the founder prohibited propagation before Chapter 14 acceptance.
