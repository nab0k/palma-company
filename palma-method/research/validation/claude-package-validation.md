...
Source fingerprint: `6a4be810fb6411dcb0672d35f38dfedf87df2d905da8d81e153f18c9395e0897`
Status: **PASS**

## Result

- Source cards found: 146
- Source cards parsed: 146
- Unique source-card IDs: 146
- Errors: 0
- Warnings: 24
...
- `related_card_reference` — research/source-cards/goenka-vipassana-organizational-system-2026.md: related-card entry has no SC ID: pagis-2015-evoking-equanimity-vipassana.md (the academic silent-sociality finding this institutional card complements)
- `related_card_reference` — research/source-cards/goenka-vipassana-organizational-system-2026.md: related-card entry has no SC ID: serhii-vipassana-retreat-story-intake.md (the author's own retreat account this card supplies organizational context for)
- `related_card_reference` — research/source-cards/goenka-vipassana-organizational-system-2026.md: related-card entry has no SC ID: lave-wenger-1991-legitimate-peripheral-participation.md (the general newcomer-to-oldtimer mechanism this card's old-student pathway is a concrete instance of)
- `related_card_reference` — research/source-cards/kraut-resnick-kiesler-2012-building-online-communities.md: related-card entry has no SC ID: ostrom source card (public-goods/commons theory, one of the core theoretical traditions this book translates into design claims)
- `related_card_reference` — research/source-cards/lave-wenger-1991-legitimate-peripheral-participation.md: related-card entry has no SC ID: wenger-1991-1998-communities-of-practice.md (Wenger's later solo elaboration of the communities-of-practice frame this book already uses; this card is the earlier, co-authored origin of the newcomer-to-oldtimer mechanism specifically)
- `related_card_reference` — research/source-cards/mccarthy-zald-1977-resource-mobilization.md: related-card entry has no SC ID: granovetter source card (weak ties; resource mobilization theory adds the organizational/resource layer on top of tie structure)
