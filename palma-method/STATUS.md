...
- [x] Engineering foundation created and versioned.
- [x] Provisional table of contents converted into 21 chapter files.
- [x] Research schemas, indexes, and initial validator created.
- [x] Claude research package received as ZIP and inventoried.
- [x] Seventeen Claude source cards imported into canonical paths.
- [x] Literature map, Anti-Palma map, conflicting-definitions note, open questions, and verification ledger imported.
- [x] Incoming schema differences documented.
- [x] Structural validation completed: 17/17 cards passed with 0 errors and 0 warnings.
...
- The repository is public; confidential live-research material must not be committed.
